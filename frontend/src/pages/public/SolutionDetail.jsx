...
const features=sol.key_features?JSON.parse(sol.key_features):[];
const usecases=sol.use_cases?JSON.parse(sol.use_cases):[];
return(<><Helmet><title>{sol.title} – V-Trinity Solutions</title><meta name="description" content={sol.short_desc}/></Helmet>
...
<p className="text-gray-300 text-lg max-w-2xl">{sol.short_desc}</p>
...
<div className="prose prose-lg max-w-none text-gray-700" dangerouslySetInnerHTML={{__html:sol.full_desc||'<p>'+sol.short_desc+'</p>'}}/>
